...
if (doSyntheicWavelengthStuff)
	sgtitle({'DORT Synthetic Singular Vector Backpropagation', ['\Lambda_{synth} = ' sprintf('%.2f', lambda*1e3) 'mm — \lambda_1 = ' sprintf('%.2f', lambdaSynthConstituentWavelengths(1)*1e9) 'nm, \lambda_2 = ' sprintf('%.2f', lambdaSynthConstituentWavelengths(2)*1e9) 'nm'], ''}, 'FontSize', 24, 'FontWeight', 'bold');
else
